...
class mdlModel(Base):
    ...
    reverseLookup = Column(String(256), index = True)
    description = Column(String(256), index=False)
    registrant =  Column(String(256), index = True)
    ...
    def __init__(self, ip = None, domain = None,  url = None,  date = None, reverseLookup = None, description = None, registrant = None):
        self.url = url
    ...
    def update(self):
        ...
        for mdlDict in mdlDictList:
            try:
                self.insert(mdlDict["ip_str"], mdlDict["domain"], mdlDict["reverseLookup"], mdlDict["date"], mdlDict["registrant"], mdlDict["description"])
    ...
    def fetch(self):
        ...
        try:
            ...
            for row in reader:
                ...
                print "IP = %s" % ip_str
                results.append({"date":date, "domain":domain, "ip_str":ip_str, "reverseLookup":reverseLookup, "description":description, "registrant": registrant})
